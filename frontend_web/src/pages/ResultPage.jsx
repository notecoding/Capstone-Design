...
export default function ResultPage() {
  ...
  // details 배열(status/score/reason 포함)을 우선 사용, 없으면 module_scores 숫자 객체 사용
  const moduleScores = result.details?.length > 0
    ? Object.fromEntries(result.details.map(d => [d.module, { score: d.score, status: d.status, reason: d.reason }]))
    : result.module_scores || null;
  ...
  return (
    <main className="max-w-content mx-auto px-fluid-md py-fluid-lg">
      <VerdictBanner   cfg={cfg} summary={result.summary} />
